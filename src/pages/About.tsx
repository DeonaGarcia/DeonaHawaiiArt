          ...
          <div className="mb-16">
            <Card className="overflow-hidden shadow-elegant group">
              <div className="relative aspect-[4/3]">
                <img src="/lovable-uploads/6eb7acf0-4b02-4852-8e6d-ff748e3acbef.png" alt="Underwater snorkeling scene capturing the beauty of marine life" className="w-full h-full object-cover object-center transition-transform duration-500 group-hover:scale-105" />
